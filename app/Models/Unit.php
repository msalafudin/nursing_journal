...
class Unit extends Model
{
    ...
    public function getFieldDefinition(): array
    {
        $fieldDefinitions = [
            ...
            'Rawat Inap' => [
                // === SENSUS (snapshot jumlah pasien saat ini per spesialis) ===
                [
                    'name' => 'Sensus pasien Anak',
                    'key' => 'sensus_anak',
                    'type' => 'numeric',
                    'required' => true,
                    'min' => 0,
                ...
                [
                    ...
                    'required' => false,
                    'auto_calculated' => true,
                    'calculation' => 'sensus_anak + sensus_dalam + sensus_saraf + sensus_obsgyn + sensus_bedah',
                ],
            ],
            'Rawat Jalan' => [
                [
