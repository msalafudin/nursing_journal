...
<div class="notification rounded-lg shadow-lg p-4 max-w-sm animate-fade-in" role="alert">
    <div class="flex items-start">
        ...
        <!-- Close Button -->
        <button type="button" class="ml-3 inline-flex text-gray-400 hover:text-gray-500 focus:outline-none" onclick="this.parentElement.parentElement.remove()">
